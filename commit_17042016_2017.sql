...
CREATE TABLE PARTY (PARTY_ID VARCHAR(5),PARTY_NAME VARCHAR(20), PARTY_SYMBOL VARCHAR(20), PRIMARY KEY (PARTY_ID), FOREIGN KEY (BLOCK_ID) REFERENCES BLOCK (BLOCK_ID));
